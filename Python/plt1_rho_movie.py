...
mat.append(sio.loadmat('V:\ipasmans\ocean2018\Exp35for_avg.mat',squeeze_me=True,struct_as_record=False))
mat.append(sio.loadmat('V:\ipasmans\ocean2018\Exp37for_avg.mat',squeeze_me=True,struct_as_record=False))
mat0=sio.loadmat('V:\ipasmans\ocean2018\Exp40ana_avg.mat',squeeze_me=True,struct_as_record=False)
